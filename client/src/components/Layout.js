...
const Layout = ({ children }) => {
  ...
  useEffect(() => {
    const handleClickOutside = (event) => {
      if (registerMenuOpen && !event.target.closest('.register-menu-container')) {
  ...
  const commonNavItems = [
    ...
    { name: 'Find Phones', href: '/posts', icon: PhoneIcon, current: location.pathname === '/posts' || location.pathname.startsWith('/posts/') },
  ];

  // User-specific navigation items
  const userNavItems = isAuthenticated && !isShop && !isAdmin ? [
    { name: 'Dashboard', href: '/dashboard', icon: Cog6ToothIcon, current: location.pathname === '/dashboard' },
    { name: 'Report Phone', href: '/create-post', icon: PhoneIcon, current: location.pathname === '/create-post' },
  ] : [];
  ...
  const adminNavItems = isAdmin ? [
    { name: 'Dashboard', href: '/dashboard', icon: Cog6ToothIcon, current: location.pathname === '/dashboard' },
    { name: 'Admin', href: '/admin', icon: Cog6ToothIcon, current: location.pathname === '/admin' },
    { name: 'Manage Shops', href: '/admin/shops', icon: BuildingStorefrontIcon, current: location.pathname === '/admin/shops' || location.pathname.startsWith('/admin/shops/') },
  ] : [];

  // About and info items at the end
  const infoNavItems = isAdmin ? [
    { name: 'About Us', href: '/about', icon: QuestionMarkCircleIcon, current: location.pathname === '/about' },
  ] : isAuthenticated ? [
    { name: 'About Us', href: '/about', icon: QuestionMarkCircleIcon, current: location.pathname === '/about' },
  ] : [
    { name: 'How It Works', href: '/about#how-it-works', icon: QuestionMarkCircleIcon, current: false },
    { name: 'About Us', href: '/about', icon: QuestionMarkCircleIcon, current: location.pathname === '/about' },
  ];
            ...
            <div className="flex items-center">
              ...
              <Link to="/" className="flex items-center space-x-2">
                ...
                <div className="hidden sm:block">
                  <h1 className="text-xl font-bold text-gray-900 transition-colors duration-300">Find My Phone.lk</h1>
                </div>
              </Link>
            </div>
              ...
              {isAuthenticated ? (
                <div className="flex items-center space-x-4">
                  ...
                  >
                    ...
                    <span className="text-sm font-medium">
                      {isShop ? user?.shop?.shopName || user?.username : user?.username}
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div className="relative register-menu-container">
                    ...
                    >
                      <span>Register</span>
                      <ChevronDownIcon className={`h-4 w-4 transition-transform duration-200 ${registerMenuOpen ? 'rotate-180' : ''}`} />
                    </button>
                    {registerMenuOpen && (
                    ...
                    to="/register"
                          ...
                          >
                            ...
                            <div>
                              ...
                              <p className="text-xs text-gray-500">Create a business account</p>
                            </div>
                  </Link>
                        </div>
                      </div>
              ...
              {isAuthenticated ? (
                <div className="pt-4 border-t border-gray-200">
                  <div className="px-3 py-2 text-sm text-gray-500">
                    Welcome, {isShop ? user?.shop?.shopName || user?.username : user?.username}
                    ...
                    to="/register"
                      ...
                      >
                        ...
                        <div>
                          ...
                          <p className="text-xs text-gray-500">For personal use</p>
                        </div>
                      </Link>
                      <Link
                        to="/register-shop"
      ...
      <footer className="bg-gray-900 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="space-y-4">
              <div className="flex items-center space-x-2">
                <img 
                  ...
                  className="h-12 w-auto mobile-logo"
                />
                <h3 className="text-xl font-bold text-white">Find My Phone.lk</h3>
              </div>
              <p className="text-gray-400 text-sm">
                Sri Lanka's premier platform for reporting and finding lost phones.
                We connect people who have lost their devices with those who have found them.
              </p>
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li>
                  <Link to="/posts" className="text-gray-400 hover:text-blue-400 transition-colors duration-200">Find Phones</Link>
                </li>
                <li>
                  <Link to="/create-post" className="text-gray-400 hover:text-blue-400 transition-colors duration-200">Report Lost Phone</Link>
                </li>
                <li>
                  <Link to="/about" className="text-gray-400 hover:text-blue-400 transition-colors duration-200">About Us</Link>
                </li>
                <li>
                  <Link to="/register-shop" className="text-gray-400 hover:text-blue-400 transition-colors duration-200">Register Shop</Link>
                </li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li>
                  <Link to="/about#how-it-works" className="text-gray-400 hover:text-blue-400 transition-colors duration-200">How It Works</Link>
                </li>
                <li>
                  <Link to="/about#faqs" className="text-gray-400 hover:text-blue-400 transition-colors duration-200">FAQs</Link>
                </li>
                <li>
                ...
                <li>
                  <button className="text-gray-400 hover:text-blue-400 transition-colors duration-200">Contact Support</button>
                </li>
              </ul>
            </div>
          ...
          <div className="mt-12 pt-8 border-t border-gray-800 flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm">
              &copy; {new Date().getFullYear()} Find My Phone.lk. All rights reserved.
            </p>
            <div className="mt-4 md:mt-0">
              <p className="text-gray-400 text-sm">
                Designed and developed with ❤️ in Sri Lanka
              </p>
            </div>
          </div>
        </div>
