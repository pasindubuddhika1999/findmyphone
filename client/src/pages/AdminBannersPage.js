...
import { ArrowUpIcon, ArrowDownIcon, PencilIcon, TrashIcon, PhotoIcon } from '@heroicons/react/24/outline';
...
const AdminBannersPage = () => {
  ...
  const handleReorder = async (id, direction) => {
    ...
    try {
      await api.put(`/api/banners/admin/${id}`, { order: newOrder }, {
        headers: getAuthHeader()
      });
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="bg-white shadow-md rounded-lg p-6">
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="mb-4">
                ...
                <div className="mt-2">
                  <label className="block text-gray-700 text-sm mb-2" htmlFor="imageUrl">
                    Or enter image URL
                  </label>
                  <input
                    type="text"
              ...
              <div className="flex items-center justify-between">
                <button
                  ...
                  disabled={isSubmitting || uploadingImage || (!selectedImage && !formData.imageUrl)}
                >
                  {isSubmitting || uploadingImage ? 'Saving...' : (editingId ? 'Update Banner' : 'Add Banner')}
                </button>
        ...
        <div className="lg:col-span-2">
          <div className="bg-white shadow-md rounded-lg overflow-hidden">
            <h2 className="text-xl font-semibold p-6 border-b">Banner Slides</h2>
            
            {loading ? (
              <div className="p-6 text-center">Loading banners...</div>
            ) : banners.length === 0 ? (
              <div className="p-6 text-center text-gray-500">No banners found. Add your first banner!</div>
            ) : (
