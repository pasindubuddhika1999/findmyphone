...
import { PhoneIcon, MapPinIcon, EyeIcon } from "@heroicons/react/24/outline";
...
const HomePage = () => {
  ...
  const { data: stats } = useQuery(
    ...
    async () => {
      ...
      const [totalResponse, activeResponse, resolvedResponse] =
        await Promise.all([
    ...
    <div className="space-y-12">
        ...
        <div className="max-w-4xl mx-auto px-4">
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            {isAuthenticated ? (
              <Link
                to="/create-post"
                className="btn-primary text-base md:text-lg px-6 md:px-8 py-2 md:py-3 w-full sm:w-auto"
              >
                Create Complaint
              </Link>
            ) : (
        ...
        {recentPosts?.posts?.length === 0 && (
          <div className="text-center py-12">
            ...
            <p className="text-gray-600">
              Try adjusting your search criteria or be the first to report a
              lost phone.
            </p>
          </div>
        )}
      ...
      <section className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        <div className="text-center">
          ...
          <p className="text-gray-600">
            Search and report phones using their unique IMEI numbers for
        ...
        <div className="text-center">
          ...
          <p className="text-gray-600">
            Find phones lost in specific areas with our location-based search
            and filtering.
          </p>
        </div>
        <div className="text-center">
          ...
          <p className="text-gray-600">
            Upload photos of your lost phone to help others identify and return
            it to you.
          </p>
        </div>
      </section>
