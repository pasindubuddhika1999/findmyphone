...
const SERVICE_ID = "service_21trvtd";
const TEMPLATE_ID = "template_9t6v3ra";
const USER_ID = "JOj00-PrzsnXAhaCT"; // This is the public API key
          ...
          <form ref={formRef} onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              <label
                ...
                className="block text-sm font-medium text-gray-700 mb-1 flex items-center"
              >
                <ChatBubbleLeftRightIcon className="h-5 w-5 mr-1 text-blue-500" />{" "}
                Message
              </label>
              <textarea
                id="message"
